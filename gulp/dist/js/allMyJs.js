! function(e, t) {
    ...
    he.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = he.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + i) : t.jsonp !== !1 && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
    ...
    $("a").click(function(e) {
        alert("you clicked something"), e.preventDefault()
    })
}), $(document).ready(function() {
    $("a").click(function(e) {
        alert("you are on admin page now!"), e.preventDefault()
    })
});
